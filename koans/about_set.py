...
def test_create():
    """
        ...
        или заключив последовательность в фигурные скобки {1, 2, 3}.
...
def test_create_from_string():
    ...
    """
    my_set = set(
        'Hello, world!')  # попробуйте такие варианты: set('Hello!'), set('Hello, world!')
...
def test_operator_len():
    ...
    """
    my_set = {0, 1, 2, 3, 4, 5}
    set_len = len(my_set)  # попробуйте такие варианты: 5, 6, 7
...
def test_list_in_set():
    ...
    """
    my_set = {1, (1, 2)}  # попробуйте такие варианты: {1, [1, 2, 3]}, {1, (1, 2, 3)}, {1, {'a': 1, 'b': 2}}
    assert isinstance(my_set, set)
